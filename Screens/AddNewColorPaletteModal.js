...
const AddNewColorPaletteModal = ({ navigation }) => {
  ...
  const handleSubmit = useCallback(() => {
    if (!paletteName) {
      Alert.alert('No name', 'you must provide a palette name');
    } else if (selectedColors.length < 3) {
      Alert.alert('Colors not enough', 'colors selected must be 3 or more');
    } else {
...
export default AddNewColorPaletteModal;
